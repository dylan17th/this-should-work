...
const mockEpisodeData = {episodes:[ {
    id: 553946,
...
test('if the episodes compoenent renders the episodes', () =>{
const { queryAllByTestId, rerender } = render(<Episodes episodes={[]} />)
expect(queryAllByTestId(/episodes/i)).toHaveLength(0);
rerender(<Episodes episodes={mockEpisodeData.episodes}/>)
expect(queryAllByTestId(/episodes/i)).toHaveLength(4);
})